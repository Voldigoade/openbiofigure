...
export const messages = {
  en: {
    ...
    favorites: "Favorites",
    recentAssets: "Recent",
    favoriteAsset: "Favorite asset",
    noFavoriteAssets: "Favorite assets appear here for quick access.",
    noRecentAssets: "Assets you add to a figure appear here.",
    scientificDrawing: "Scientific drawing",
    importLocalSvg: "Import local SVG",
    style: "Style",
    position: "Position",
    layers: "Layers",
  ...
  fr: {
    ...
    assetViews: "Vues des ressources",
    allAssets: "Toutes",
    favorites: "Favoris",
    recentAssets: "Récentes",
    favoriteAsset: "Ajouter aux favoris",
    noFavoriteAssets: "Les ressources favorites apparaissent ici.",
    noRecentAssets: "Les ressources ajoutées à une figure apparaissent ici.",
    scientificDrawing: "Dessin scientifique",
    importLocalSvg: "Importer un SVG local",
    style: "Style",
    position: "Position",
    layers: "Calques",
